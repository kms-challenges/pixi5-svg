...
Snap.plugin(function (Snap, Element, Paper, glob) {
    ...
    function interPathHelper(path1, path2, justCount) {
        ...
        for (var i = 0; i < res.length; i++){
            ...
            if (fin.length != 0) {
                ...
                if (Math.abs(last.x - r.x) > e ||
                    Math.abs(last.y - r.y) > e) {
                    fin.push(r);
                }
            } else {
                fin.push(r);
    ...
    function isPointInsidePath(path, x, y) {
        ...
        //var auxPath = [["M", x, y], ["H", bbox.x2 + 10]];
        var start_x = x;
        var end_x = bbox.x2+10;
        var l = end_x-start_x;
        var auxPath;
        var r = [];
        r[true] = 0;
        ...
        for (var i = 0; i < 5; i++){
            auxPath = [["M", x, y], [
                "C", start_x+(l/3), y+100*(Math.random()-0.5),
                start_x+(2*l/3), y+100*(Math.random()-0.5),
                end_x, y
            ]];
            r[interPathHelper(path, auxPath, 1) % 2 == 1]++;
        }
        if (r[true] > r[false])
            return true;
        else
